 ...
 if(isset($_POST["register"])){
       ...
       if(empty($_POST["firstname"])){
          ...
          $mobilenumErr="mobile number is required";
            ...
            $fplaceErr="fromplace is required";
       }elseif(!preg_match("/^[a-zA-Z\s]*$/",$place)){
            $fplaceErr="enter a valid place";
       }elseif(empty($_POST["dplace"])){
            $dplaceErr="destinationplace is required";
            ...
            $dateErr="date is required";
             ...
             $vehicleErr="enter a valid vehicle number";
              ...
              $sql="INSERT INTO `registration`(`customer id`,`firstname`, `lastname`, `email`, `phonenumber`, `reason`,`district`,`from place`,`destination district`,`destination place`, `date`, `vehicle number`, `file for reason`) 
                VALUES ('$id','$fname','$lname','$email','$mobilenum','$reason','$district','$city','$ddistrict','$dcity','$date','$vehicle','$destination')";

                 $result=mysqli_query($conn,$sql); 
                 if($result == TRUE){
                        header("Location:mail.php?success=file uploaded successfully");
                  }else{
                    echo "sql error";
                  }
              }
